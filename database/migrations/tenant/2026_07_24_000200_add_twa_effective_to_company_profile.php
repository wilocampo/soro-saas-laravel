...
/**
 * D27 (draft answers 2026-07-24; licensed CPA sign-off pending) — Top
 * Withholding Agent status is bounded at BOTH ends.
 *
 * We modelled TWA status as a flag plus a start date, on the assumption that
 * a designation, once made, ran until someone changed the flag. The research
 * draft corrected that: de-listing takes effect by publication exactly as
 * listing does, so the status has an end date too.
 *
