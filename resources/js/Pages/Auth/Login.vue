...
<template>
    ...
    <div class="bg-surface-50 dark:bg-surface-950 flex items-center justify-center min-h-screen min-w-[100vw] overflow-hidden">
        <div class="flex flex-col items-center justify-center">
            <div class="shadow-md" style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, var(--primary-color) 10%, rgba(33, 150, 243, 0) 30%)">
                <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20" style="border-radius: 53px">
                    ...
                    <form @submit.prevent="submit">
                        <div>
                            ...
                            />
                            <div v-if="form.errors.email" class="text-red-500 text-sm mb-4">{{ form.errors.email }}</div>
                            ...
                            <div class="flex items-center justify-between mt-2 mb-8 gap-8">
                                ...
                                <Link v-if="canResetPassword" :href="route('password.request')" class="font-medium no-underline ml-2 text-right cursor-pointer text-primary">
                                    Forgot password?
                                </Link>
                            </div>
                            <Button label="Sign In" class="w-full" type="submit" :disabled="form.processing" />
                        </div>
                    </form>
                </div>
            </div>
