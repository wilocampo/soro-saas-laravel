...
// Get user data from Laravel authentication
const user = computed(() => {
...
const userMenuItems = ref([
    ...
    { label: 'Logout', icon: 'pi pi-sign-out', action: 'logout', method: 'POST', danger: true }
]);

// Notification data - this could come from props, store, or API
...
const handleUserMenuItemClick = (item) => {
    ...
    switch (item.action) {
        case 'logout':
            // Use Inertia router for POST logout
            router.post('/logout');
            break;
        case 'profile':
        case 'settings':
        default:
            // Default navigation handled by component
            if (item.href) {
    ...
    <div class="layout-topbar">
        ...
        <div class="layout-topbar-actions">
            ...
            <UserDropdown 
                ...
                @menu-item-clicked="handleUserMenuItemClick"
            />
        </div>
    </div>
</template>
